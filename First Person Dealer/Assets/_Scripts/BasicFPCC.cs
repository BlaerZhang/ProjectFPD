...
public class BasicFPCC : MonoBehaviour
{
    ...
    void ProcessLook()
    {
        ...
        float mouseX = smoothMouseLook
            ? accMouseX * mouseSensitivityX * 100f * Time.deltaTime
            : inputLookX * mouseSensitivityX * 100f * Time.deltaTime;
        float mouseY = smoothMouseLook
            ? accMouseY * mouseSensitivityY * 100f * Time.deltaTime
            : inputLookY * mouseSensitivityY * 100f * Time.deltaTime;
